...
const sections: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: ["Playgroup 2–3 yrs, Nursery 3–4 yrs, LKG 4–5 yrs, UKG 5–6 yrs."],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        q: "What is the ratio?",
        a: ["Approximately 10:1 to ensure personal attention and support."],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: ["Yes, separate summer and winter uniforms."],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: [
          "Child‑centric, positive behaviour management. No corporal punishment. Structured engagement and clear routines.",
        ],
      },
    ],
  },
  {
    ...
    items: [
      {
        q: "Which languages are used?",
        a: [
          "English medium with Hindi/Regional language support for comfort and inclusion.",
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        a: [
          "Centre tours, orientation programs, regular PTMs, workshops, and app‑based updates.",
        ],
      },
    ],
  },
  {
    ...
    items: [
      {
        q: "Are transfers possible?",
        a: [
          "Yes, inter‑centre transfers are supported subject to seat availability.",
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        a: [
          "Typical operating hours align with preschool schedules; the academic calendar and holiday list are shared at admission.",
        ],
      },
    ],
  },
          ...
          (it) =>
            ...
            it.a.some((a) =>
              typeof a === "string"
                ...
                : a.bullet.some((b) => b.toLowerCase().includes(q)),
            ),
        ),
      }))
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-3 text-slate-600">
            Find quick answers about curriculum, admissions, safety, and more.
          </p>
          ...
          {filtered.map((sec) => (
            ...
            >
              <header className="flex items-center gap-2 p-4 border-b">
                <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-sky-100 to-emerald-100 text-slate-700">
                  {sec.icon}
                </span>
                        ...
                        {qa.a.map((ans, i) =>
                          typeof ans === "string" ? (
                            <p key={i} className="mb-2">
                              <Match text={ans} q={query} />
                            </p>
                          ) : (
                            <ul key={i} className="list-disc pl-6 space-y-1">
                              {ans.bullet.map((b) => (
                                <li key={b}>
                                  <Match text={b} q={query} />
                                </li>
                              ))}
                            </ul>
                          ),
