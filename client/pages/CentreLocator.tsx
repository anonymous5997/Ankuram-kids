      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-3 text-slate-600">
            Find our Ankuram Kids centre in Bhubaneswar.
          </p>
        </div>
        ...
        <motion.div
          ...
          className="mt-10 grid lg:grid-cols-5 gap-6 items-start"
        >
        ...
        <div className="mt-8 max-w-xl mx-auto">
          <input
            className="w-full rounded-full border border-border bg-white px-4 py-3 text-sm shadow-sm"
            placeholder="Search centres (more coming soon)..."
          />
        </div>
      </div>
    </div>
