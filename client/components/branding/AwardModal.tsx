...
export default function AwardModal({ open, onClose, imageSrc, heading = "Odisha’s No. 1 School", subheading = "Times School Ranking Survey Odisha 2023", supporting = "Awarded for the 4th Consecutive Year by TIMES OF INDIA" }: AwardModalProps) {
